    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserMenuPermissionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMenuPermissions", x => x.UserMenuPermissionId);
                    table.ForeignKey(
                        name: "FK_UserMenuPermissions_ApplicationUser_UserId1",
                        column: x => x.UserId1,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMenuPermissions_Permissions_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "Permissions",
                        principalColumn: "PermissionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductName_UnitId",
                table: "Products",
                columns: new[] { "ProductName", "UnitId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMenuPermissions_PermissionId",
                table: "UserMenuPermissions",
                column: "PermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMenuPermissions_UserId1",
                table: "UserMenuPermissions",
                column: "UserId1");
